...
//	}
	...
	private void initialize() {
		...
		JLabel welcomeLbl = new JLabel("<html><div style='text-align: center;'>"
		...
		btnLogIn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (validate(textUsername.getText(), textPassword.getText())) {
					System.out.println("Username: " + textUsername.getText());
				} else
