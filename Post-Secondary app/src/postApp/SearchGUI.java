...
public class SearchGUI implements ActionListener, KeyListener {
	...
	private void setSearchLayout() {
		...
		basicSearch.setBounds(10, 475, 180, 75);
		...
		altSearch.setBounds(200, 475, 180, 75);
		...
		comboSearch.setBounds(390, 450, 180, 75);
