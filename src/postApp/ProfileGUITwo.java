...
public class ProfileGUITwo extends JFrame {
	...
	public ProfileGUITwo() {
		...
		next.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				...
				if (ProfileGUIThree.volunteerHourChoice != null) {
					if (ProfileGUIThree.volunteerHourChoice == true) {
						ProfileGUIThree.choiceYes.setIcon(new ImageIcon("images/choices.png"));
					} else {
						ProfileGUIThree.choiceNo.setIcon(new ImageIcon("images/choices.png"));
					}
